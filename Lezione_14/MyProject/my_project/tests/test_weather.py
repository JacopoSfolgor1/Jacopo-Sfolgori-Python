...
def test_check_weather5():
    assert check_weather(30.00) == "hot", 'temperatures greater than 20 must be considered as hot'
    assert check_weather(11.00) == "cold", 'temepratures lower than 10 degree must be considered as cold'

@pytest.mark.parametrize("temperature, expected", [
(21.00, "hot"), # passed
(13.00, "average"), # passed 
(0.00, "cold"), # passed
(15.00, "cold") # failed
])
def test_check_weather6(temperature, expected):
