...
(specificato con "m" per maschio o "f" per femmina) e utilizzi lo statement match per fornire una risposta adeguata da 
inserire in un documento di identita'.
...
gender:str = input("Inserisci il gender m o f: ")

match nome, gender:
    case name, "m":
        print(f"{name} è maschio")
    case name, "f":
        print(f"{name} è femmina")
    case _:
        print("errore gender not found")
