...
euro = float(input("inserisci quanti soldi vuoi spendere per la cioccolata: ")) 
cioccolato:int = 0
buono: int = 0
while euro > 0:
    cioccolato += 1
    ...
    if buono == 6:
        cioccolato += 1
        buono = 0 #resetto il contatore ogni volta raggiunge 6 buoni
    euro -= 1
    
print(f"barrette comprate: {cioccolato}\nsconti rimanenti: {buono}")
