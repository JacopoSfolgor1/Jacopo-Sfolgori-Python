...
while True:     
    ...
    while posH < 70 and posT < 70:          
        ...
        #controllo ostacoli tartaruga e se under 1
        if posT in ostacoli:               
        ...
        #controllo bonus tartaruga e se over 70
        elif posT in bonus:                 
        ...
        #controllo ostacoli lepre e se under 1
        if posH in ostacoli:               
            print("_ " * 71)
        ...
        #controllo bonus lepre e se over 70
        elif posH in bonus:                
            print("_ " * 71)
